...
Since Goozers are such a rarity, when they are found in the small hamlets around the outskirts of Pot, they adopt whatever society that has adopted them. However, in the bustling cities of [[Umm/Locations/Fofam\|Fofam]], [[Umm/Locations/Shoe\|Shoe]], and [[Umm/Locations/Mountmouth\|Mountmouth]], Goozers will often form small groups. They'll often live in the decrepit abandon parts of town - the areas that most remind them of their home - and search secret meeting places that can only be accessed by having Goozer traits.
